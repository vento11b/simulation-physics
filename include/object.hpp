...
struct Object {
    ...
    Object(Mesh* _mesh) : Object(glm::vec2{400.0f, 300.0f}, glm::vec2{200.0f}, 0.0f, glm::vec<3, unsigned char>{0, 0, 255}, _mesh, &default_shader) {};
    Object(Shader* _shader) : Object(glm::vec2{400.0f, 300.0f}, glm::vec2{200.0f}, 0.0f, glm::vec<3, unsigned char>{0, 0, 255}, &default_mesh, _shader) {};
